...
export function FAQ({ solutionId, solutionTitle }: FAQProps) {
  ...
  const loadFAQs = async () => {
    try {
      ...
      // For now, we'll use mock data that's solution-specific
      const mockFAQs: FAQ[] = [
        {
          id: '1',
          question: `How does this ${solutionTitle} solution work in practice?`,
          answer: 'This IITA solution has been developed through extensive research and field testing across multiple African countries. It incorporates climate-smart techniques that have been proven to increase productivity while building resilience to climate variability.',
          createdAt: new Date().toISOString()
        },
        {
          id: '2',
          question: 'What support does IITA provide for implementation?',
          answer: 'IITA provides comprehensive support including technical training, extension materials, quality assurance protocols, and ongoing monitoring. We work with local partners to ensure successful adoption and scaling.',
          createdAt: new Date().toISOString()
        },
        {
          id: '3',
          question: 'What are the typical results farmers can expect?',
          answer: 'Results vary by location and implementation, but farmers typically see improved yields, reduced input costs, enhanced climate resilience, and better market access. IITA provides detailed impact data for each solution.',
          createdAt: new Date().toISOString()
        }
      ];
